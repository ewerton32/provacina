...
public class BdAnimal implements RepositorioAnimais {

	private static BdAnimal instance;
    ...
    public synchronized static BdAnimal getInstance() {
        if (instance == null) {
            instance = new BdAnimal();
        }
        return instance;
    }
