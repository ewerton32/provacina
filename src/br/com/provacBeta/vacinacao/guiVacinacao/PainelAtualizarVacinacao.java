...
public class PainelAtualizarVacinacao extends JPanel {
	JLabel nomePainel = new JLabel("Atualizar vacinação");	
	JLabel informe = new JLabel("Digite o numero da vacinação");	
	...
	public PainelAtualizarVacinacao(JPanel painelCentro){
