...
public class PainelProcurarVacinacao extends JPanel {
	JLabel nomePainel = new JLabel("Procurar vacinação");	
	JLabel informe = new JLabel("Digite o número da vacinação");	
	...
	public PainelProcurarVacinacao(JPanel painelCentro){
