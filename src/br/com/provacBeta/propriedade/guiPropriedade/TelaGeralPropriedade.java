...
public class TelaGeralPropriedade extends JFrame{
	...
	public TelaGeralPropriedade(Usuario usuario){
    	super("Gerenciamento de propreidades");
...
//
    ...
    public static void main(String[] args) {
    	...
    	TelaGeralPropriedade tela = new TelaGeralPropriedade(usuarioChave);
