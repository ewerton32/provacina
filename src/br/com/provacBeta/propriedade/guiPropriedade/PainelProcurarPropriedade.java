...
public class PainelProcurarPropriedade extends JPanel {
	JLabel nomePainel = new JLabel("Procurar propriedade");	
	...
	public PainelProcurarPropriedade(JPanel painelCentro){
